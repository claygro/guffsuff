  ...
  return (
    <>
      <div className="flex justify-between  items-center">
        ...
        <div className="bg-gray-800 w-fit text-white rounded-full text-sm whitespace-nowrap hover:bg-gray-700 active:bg-gray-900 cursor-pointer m-2  px-3 py-1">
          <h1>Your Request</h1>
        </div>
        ...
        <div className="bg-gray-800 w-fit text-white rounded-full text-sm hover:bg-gray-700 active:bg-gray-900 cursor-pointer m-2  px-3 py-1">
          <h1>Accepted</h1>
        </div>
      </div>
    </>
